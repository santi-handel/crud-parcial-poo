...
export default function BtnDelete(props) {
    ...
    return (
        <button onClick={handleDelete} className="btn btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-x-fill" viewBox="0 0 16 16">
